...
/// <summary>
/// Specialized lightweight DTO for populating dropdown menus and selection lists.
/// Supports hierarchical visualization via indentation levels.
/// </summary>
...
public record BoxLookupListDto(
    int BoxId,
    string Name,
